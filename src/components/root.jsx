...
class FlowManager extends React.Component {
    ...
    render() {
        ...
        const runTestButtonClasses = (this.props.flow.steps !== undefined && this.props.flow.steps.length > 0) ? 'button button_bluewood button_sm' : 'button button_bluewood button_sm disabled';
                ...
                <div className={flowManagerClasses}>
                    <div className="page-header text-center clearfix">
                        ...
                        <div className="button-group pull-right">
                            ...
                            <a className="button button_valencia button_sm" href={'/flow/' + this.props.flow.id + '/delete'}><span className="fa fa-trash-o" /></a>
                        </div>
                    </div>
                    <div className="row">
